    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        with torch.no_grad():
            ...
            if iteration == opt.iterations:
                ...
                # extracted_watermarked_indices, extracted_watermarked_positions = gaussians.extract_watermark()
                # indices_list = extracted_watermarked_indices.cpu().tolist()
                # print(f"extracted_indices_list: {indices_list}")
                # compare_results = gaussians.compare_watermarks()
